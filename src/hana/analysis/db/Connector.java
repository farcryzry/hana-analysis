...
public class Connector {
	...
	String password = "Pal654321";
	String dbms = "sap";
	String serverName = "uvo18xkc8psz3esbdmw.vm.cld.sr";
	...
	/*
	public JSONArray QueryAsJSON(String sql) throws Exception {
		return convertToJSON(Query(sql));
	}*/

	private List<HashMap<String, Object>> resultSetToHashMap(ResultSet rs) throws SQLException {
	...
	public static JSONArray convertToJSON(List<HashMap<String, Object>> list) throws Exception {
